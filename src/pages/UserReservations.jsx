        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-[2rem] shadow-sm border-b-4 border-green-500 flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-xl font-black text-green-600 uppercase italic">{sessions[0]?.status === 'active' ? 'En el campus' : 'Fuera'}</p>
            </div>
          </div>
        </div>
      </div>

      <div className="flex-1 overflow-y-auto pr-4 custom-scrollbar-sm pb-10">
        <div className="grid gap-6">
          {sessions.map((session) => (
            ...
            >
              <div
                className={`w-24 h-24 rounded-[2rem] flex flex-col items-center justify-center font-black shrink-0 shadow-lg ${
