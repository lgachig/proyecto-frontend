  ...
  return (
    <div className="bg-[#1A1A1A] rounded-[50px] shadow-2xl p-12 border border-gray-800 flex flex-col h-[600px] w-full">
      <div className="flex justify-between items-center mb-10 px-4">
        <h2 className="text-4xl font-black uppercase text-white flex items-center gap-6 font-inter">
          <MapIcon size={45} className="text-parking-primary" />
      ...
      <div className="flex-1 w-full bg-neutral-900 overflow-hidden rounded-[40px] relative flex items-center justify-center">
        <div className="absolute inset-0 h-full w-full animate-pulse" style={{ background: 'linear-gradient(to bottom, transparent, rgba(231, 125, 85, 0.05), transparent)' }}></div>
